      ...
      <Tooltip delayDuration={1000}>
        <TooltipTrigger asChild>
          <Button
            ...
            className="ml-auto flex h-10 w-[95px] flex-row items-center justify-center gap-2 rounded-xl px-0 disabled:opacity-50"
        ...
        <Tooltip delayDuration={1000}>
          <TooltipTrigger asChild>
            <Button
              ...
              type="button"
              variant="none"
              className="ml-2 flex h-10 w-10 flex-row items-center justify-center rounded-xl p-0"
