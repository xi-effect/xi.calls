 ...
 * Курсив — запас справа: наклон глифа вылезает из метрики и сталкивается со следующим символом.
 */
const chatInlineMarksClassName = cn(
  '[&_strong]:font-bold',
  '[&_em]:italic [&_em]:pr-[0.18em]',
  '[&_s]:line-through',
  '[&_u]:underline',
);
...
export const chatProseClassName = cn(
  ...
  '[&_.ProseMirror_em]:italic [&_.ProseMirror_em]:pr-[0.18em]',
